...
/*   Updated: 2021/05/09 03:13:33 by bentowski        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void points_calcul(t_objs *py, t_triade p[5], t_triade vdir[3], t_base *base)
{
	...
	p[1].x = py->base->origins->x - (vdir[0].x * (py->height / 2)) - vdir[1].x * (py->diam / 2) - vdir[2].x * (py->diam / 2);
	p[1].y = py->base->origins->y - (vdir[0].y * (py->height / 2)) - vdir[1].y * (py->diam / 2) - vdir[2].y * (py->diam / 2);
	p[1].z = py->base->origins->z - (vdir[0].z * (py->height / 2)) - vdir[1].z * (py->diam / 2) - vdir[2].z * (py->diam / 2);
	p[2].x = py->base->origins->x - (vdir[0].x * (py->height / 2)) - vdir[1].x * (py->diam / 2) + vdir[2].x * (py->diam / 2);
	p[2].y = py->base->origins->y - (vdir[0].y * (py->height / 2)) - vdir[1].y * (py->diam / 2) + vdir[2].y * (py->diam / 2);
	p[2].z = py->base->origins->z - (vdir[0].z * (py->height / 2)) - vdir[1].z * (py->diam / 2) + vdir[2].z * (py->diam / 2);
	p[3].x = py->base->origins->x - (vdir[0].x * (py->height / 2)) + vdir[1].x * (py->diam / 2) - vdir[2].x * (py->diam / 2);
	p[3].y = py->base->origins->y - (vdir[0].y * (py->height / 2)) + vdir[1].y * (py->diam / 2) - vdir[2].y * (py->diam / 2);
	p[3].z = py->base->origins->z - (vdir[0].z * (py->height / 2)) + vdir[1].z * (py->diam / 2) - vdir[2].z * (py->diam / 2);
	p[4].x = py->base->origins->x - (vdir[0].x * (py->height / 2)) + vdir[1].x * (py->diam / 2) + vdir[2].x * (py->diam / 2);
	p[4].y = py->base->origins->y - (vdir[0].y * (py->height / 2)) + vdir[1].y * (py->diam / 2) + vdir[2].y * (py->diam / 2);
	p[4].z = py->base->origins->z - (vdir[0].z * (py->height / 2)) + vdir[1].z * (py->diam / 2) + vdir[2].z * (py->diam / 2);
}
...
int	news_objs(t_objs *py, t_objs ***objs)
{
	...
	if (new_tr(&tr[0], p[0], p[3], p[1], py))
		if (new_tr(&tr[1], p[0], p[2], p[1], py))
			if (new_tr(&tr[2], p[0], p[4], p[2], py))
				if (new_tr(&tr[3], p[0], p[4], p[3], py))
					if (new_tr(&tr[4], p[1], p[2], p[4], py))
...
int init_py2(char *line, int i, t_objs *py)
{
